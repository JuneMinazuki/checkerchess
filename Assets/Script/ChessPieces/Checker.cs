...
public class Checker : ChessPiece
{
    public override List<Vector2Int> GetAvailableMoves(ref ChessPiece[,] board, int tileCountX, int tileCountY)
    {
        ...
        AddJumpMoves(moves, board, tileCountX, tileCountY, direction);
    ...
    private void AddJumpMoves(List<Vector2Int> moves, ChessPiece[,] board, int tileCountX, int tileCountY, int direction)
    {
